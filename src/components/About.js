...
function About() {
    ...
    return (
        <div> 
          ...
          <div className="gradient-border overlay" ref={containerRef} style={{ backgroundColor: '#f9ddda', backgroundImage: `url(${pinkCloud})`, backgroundSize: 'cover', backgroundAttachment: 'fixed', backgroundRepeat: 'repeat', borderBottom: '5px solid'}}>
              <div className="max-1200px flex block-700" style={{ alignItems: 'flex-end', justifyContent: 'center' }}>
                  <div className="max-60 min-60 text-left" style={{ padding: '25vh 20px 25vh 0' }}>
                      ...
                      <p className="separator" style={{ marginTop: '0' }}><span className="typewriter keep-width">Web Developer</span></p>
