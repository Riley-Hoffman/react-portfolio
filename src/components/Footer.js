        ...
        <footer className="min-h-[89px] border-t border-solid bg-pink-200 gradient-border">
            ...
            <div className="max-w-screen-xl py-7 md:items-center md:justify-between md:flex">
                <p className="px-3 py-1 m-0 font-urbanist text-base"><span>Riley Hoffman</span> | Web Developer 
                    <a className="min-w-[34px] min-h-[30px] inline-block no-underline md:min-w-[24px] md:min-h-[20px] group" href="https://github.com/Riley-Hoffman/react-portfolio" target="_blank" rel="noopener noreferrer" aria-label="Site repo on Github"> <FontAwesomeIcon className="ml-1 text-3xl md:text-base group-hover:text-purple-200 group-focus:text-purple-200" icon={faGithub} /></a>
                </p>
